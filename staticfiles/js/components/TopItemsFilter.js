...
const TopItemsFilter = ({ contentType, setContentType, timeRange, setTimeRange }) => {
    ...
    const timeRangeDescriptions = {
      short_term: 'Showing your top tracks/artists from the last 4 weeks',
      medium_term: 'Showing your top tracks/artists from the last 6 months',
      long_term: 'Showing your top tracks/artists of all time'
    };
